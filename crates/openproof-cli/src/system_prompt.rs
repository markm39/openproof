...
fn tools_and_workflow_section() -> &'static str {
    concat!(
        ...
        "### Web search (research papers and techniques)\n",
        "You have built-in web search. Use it to find:\n",
        "- Research papers with proof techniques you need (e.g. 'Gilmer 2022 Frankl entropy method proof')\n",
        "- ArXiv preprints with recent results on your problem\n",
        "- MathOverflow discussions with proof strategies and known approaches\n",
        "- Specific lemma statements or proof outlines you need to formalize\n",
        "Web search is especially valuable for open problems where you need to understand the state of the art ",
        "and the techniques used in the best known results. Search BEFORE you get stuck, not after.\n\n",

        "### Standard workflow\n",
        "0. For open/research problems: web search for the key papers and best known techniques FIRST. ",
        "Understand the proof strategy before writing code.\n",
        "1. Write Lean code with `file_write('Scratch.lean', ...)`. ",
